...
class PostPdf extends Component{
    state ={
        companyName :"",
        companyAddress:"",
        message:"",
    ...
    render(){
        return(
         ...
         (<section id="content">
            ...
            <PDF companyName={this.state.companyName}  companyAddress={this.state.companyAddress} message= {this.state.message} date ={this.state.date}/>
        )
    }
            </>
        )
